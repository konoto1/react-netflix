...
-   Create Netflix main page with React.js
...
1. Clone the repo
    ```sh
    git clone https://github.com/konoto1/react-netflix.git
    ```
...
Tomas: [Github](https://github.com/tomasdargis)
